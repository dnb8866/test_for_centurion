...
from src.utils.entities import Repository
from src.utils.models_orm import ProductOrm, CategoryOrm
from src.utils.schemas import Product, Category, ProductBase, CategoryBase
...
class CategoryRepository(Repository):
    ...
    async def get(self, category_id: int) -> Category | None:
        async with self.db.SessionLocal() as session:
            ...
            return Category.model_validate(category_orm) if category_orm else None
